module Textor
{
    export class JavaScriptLanguage implements ILanguage
    {
        ...
        private _blockStatements = { 'if': true, 'while': true, 'with': true, 'for': true, 'else': true, 'do': true, 'try': true, 'catch': true, 'finally': true, 'switch': true, 'case': true, 'default': true };
