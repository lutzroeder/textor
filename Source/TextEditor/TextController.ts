module Textor
{
    export class TextController
    {
        ...
        constructor(textEditor: TextEditor, canvas: HTMLCanvasElement)
        {
            ...
            this._textArea = <HTMLTextAreaElement> document.createElement("textarea");
        ...
        private textArea_keyPress(e: KeyboardEvent)
        {
            ...
            if (e.ctrlKey == e.altKey && !e.metaKey && e.charCode !== 0)
            {
                ...
                this.stopEvent(e);
                var text: string = String.fromCharCode(e.charCode);
        ...
        private mouseScroll()
        {
            var textPosition: TextPosition = this.getTextPosition();
        ...
        private mouseScroll_interval()
        {
            ...
            var size: TextPosition = this._textEditor.size;
        ...
        {
            var devicePixelRatio: number = this._textEditor.devicePixelRatio;
